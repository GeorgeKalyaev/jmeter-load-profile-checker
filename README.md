...
**Preview without opening the file:** use a screenshot in the README (full-page capture of the HTML — tall image; on GitHub click the image to view it at full size):
