...
**Preview without opening the file:** use a screenshot in the README (full-page capture at the same viewport size as in the browser, ~1387×3731 px; on GitHub click the image to zoom):
