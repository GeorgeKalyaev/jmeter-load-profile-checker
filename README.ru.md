...
**Картинка «сразу в README»** — скриншот **всей страницы** отчёта, уменьшенный в 2 раза по ширине/высоте, чтобы файл был легче (на GitHub нажмите на картинку для просмотра):
